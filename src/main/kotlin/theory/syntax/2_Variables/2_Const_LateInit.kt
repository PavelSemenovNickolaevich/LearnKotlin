package theory.syntax.`2_Variables` // цифры нежелательно добавлять в название пакета, но для обучения удобней будет использовать нумерацию пакетов (чтобы соблюдать последовательность)
